...
class CheckpointPlugin(BasePlugin[BaseTemplate]):
    """
    ...
    def after_eval(self, strategy: BaseTemplate, *args, **kwargs):
        if self._training:
    ...
    def before_rollout(self, strategy: BaseTemplate, *args, **kwargs):
        pass

    def after_rollout(self, strategy: BaseTemplate, *args, **kwargs):
        pass
